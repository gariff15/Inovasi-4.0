...
def show_results():
    ...
    # 18-category pairing dictionary (pair -> recommendation)
    pairing_map = {
    ...
    # Display results with confetti and animations
    st.markdown("""
    ...
    with col1:
        st.markdown(f"""
        <div style="background: #f7f3ff; border-radius: 18px; padding: 1.5rem 1.2rem; margin-bottom: 2rem;
                    box-shadow: 0 3px 18px rgba(138, 43, 226, 0.13); border-left: 5px solid #8A2BE2;">
    ...
    with col2:
        st.markdown(f"""
        <div style="background: #fffbe5; border-radius: 18px; padding: 1.5rem 1.2rem; margin-bottom: 2rem;
                    box-shadow: 0 3px 18px rgba(255, 215, 0, 0.13); border-left: 5px solid #FFD700;">
    ...
    # Show Employer Action based on pairing
    st.markdown(f"""
