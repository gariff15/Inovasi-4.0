...
st.markdown("Answer the questions and click **Assess** to see your results and animations!")
...
def show_animation(animation_key):
    animations = {
    ...
    if url:
        ...
        <div class="animation-container">
            <lottie-player src="{url}" background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay></lottie-player>
        </div>
        """, height=350)
