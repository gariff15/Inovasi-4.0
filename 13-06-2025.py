...
def show_header():
    ...
    <div style="margin-bottom: 2rem;">
        <lottie-player 
            ...
            speed="1" 
            style="width: 120px; height: 120px; margin: 0 0 0 0;"
            autoplay>
        </lottie-player>
...
# --- Pairing logic for recommendations ---
PAIR_RECOMMENDATION = {
...
def get_recommendation(stress_level, perf_level):
    return PAIR_RECOMMENDATION.get((stress_level, perf_level), ("-", ""))
...
def show_results():
    ...
    # Get recommendation
    recommendation, employer_action = get_recommendation(stress_level, perf_level)
    ...
    <div class="recommend-box">
        <span class="action-title">Recommendation:</span> <b>{recommendation}</b>
        {"<br><span class='action-title'>Employer Action:</span> <b>" + employer_action + "</b>" if employer_action else ""}
    </div>
    """, unsafe_allow_html=True)
    st.markdown("---")
